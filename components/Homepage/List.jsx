...
const List = () => {
  return (
    <View className="px-8">
      <Text className="text-white text-2xl">Payment List</Text>
      <View className="flex flex-row flex-wrap items-center  py-2 gap-3">
        <View className="flex-col gap-2 items-center">
          ...
          <Text className="text-gray-400">Electricity</Text>
        </View>
        <View className="flex-col gap-2 items-center">
          <View className="flex items-center justify-center px-3 bg-slate-800 h-14 w-14 rounded-md">
            <Feather name="wifi" size={24} color="cyan" />
          </View>
          <Text className="text-gray-400">Internet</Text>
        </View>
        <View className="flex-col gap-2 items-center">
          <View className="flex items-center justify-center px-3 bg-slate-800 h-14 w-14 rounded-md">
        ...
        <View className="flex-col gap-2 items-center">
          ...
          <Text className="text-gray-400">Merchant</Text>
        </View>
        <View className="flex-col gap-2 items-center">
          <View className="flex items-center justify-center px-3 bg-slate-800 h-14 w-14 rounded-md">
            <Entypo name="mobile" size={24} color="blue" />
          </View>
          <Text className="text-gray-400">Top-Up</Text>
        </View>
        <View className="flex-col gap-2 items-center">
          <View className="flex items-center justify-center px-3 bg-slate-800 h-14 w-14 rounded-md">
            <Octicons name="checklist" size={24} color="yellow" />
          </View>
          <Text className="text-gray-400">Bills</Text>
        </View>
        <View className="flex-col gap-2 items-center">
          <View className="flex items-center justify-center px-3 bg-slate-800 h-14 w-14 rounded-md">
